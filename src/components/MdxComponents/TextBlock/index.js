...
const TextBlock = ({ theme, children, padding = "2rem 1.5rem" }) => {
  ...
  switch (theme) {
    case "success":
      iconElement = <FontIcon>check_circle_outline</FontIcon>
      break
    case "warning":
      iconElement = <FontIcon>warning</FontIcon>
      break
    case "danger":
      iconElement = <FontIcon>block</FontIcon>
      break
    // For 'info' & 'primary'
    default:
      iconElement = <FontIcon>info</FontIcon>
  }
